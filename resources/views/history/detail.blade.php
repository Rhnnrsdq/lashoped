...
<div class="container">
  <div class="row">
  	<div class="col-md-12">
  		<a href="{{ url('history') }}" class="btn btn-primary"><i class="far fa-arrow-alt-circle-left"></i> Kembali</a>
  	</div>
    ...
    <div class="col-md-12 mt-3">
         ...
         <li class="breadcrumb-item"><a href="{{ url('history') }}">History Order</a></li>
   ...
   <div class="col-md-12">
    <div class="card">
      <div class="card-body">
        <h3>Success Check out</h3>
        <h6>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer ke rekening <strong>Bank Mandiri Syariah No. Rekening : 7149957824</strong> dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong></h6>
      </div>
    </div>
